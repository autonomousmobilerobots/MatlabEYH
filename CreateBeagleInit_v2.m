function ports = CreateBeagleInit_v2(remoteHost, port_adder)
...
ports.create = tcpip(remoteHost, createPort, 'LocalPort', createPort+port_adder*2);
ports.beagle = tcpip(remoteHost, beaglePort, 'LocalPort', beaglePort+port_adder*2);
